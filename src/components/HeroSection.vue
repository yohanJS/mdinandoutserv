      ...
      <div class="row g-0">
        <div class="col-md-12 shadow-lg position-relative">
          ...
          <div class="row text-center text-white m-0 pb-5" style="position: absolute; top: 0; left: 0; width: 100%; height: 100vh; z-index: 1;">
            ...
            <div class="col-12">
              <button id="freeQuoteBtn" class="btn btn-lg rounded-pill btn-color btn-text-color fw-bold" style="width: 250px;" onclick="window.location.href='#getQuote'">Get a free quote</button>
...
window.onload = () => {
  let freeQuoteBtn = document.getElementById("freeQuoteBtn");
  ...
  if  (isMobile < 600) {
    ...
    servicesBtn.classList.remove("mr-r");
    freeQuoteBtn.classList.add("mt-3");
    servicesBtn.classList.add("mt-3");
  } else {
    freeQuoteBtn.classList.add("me-2");
    servicesBtn.classList.add("mr-r");
